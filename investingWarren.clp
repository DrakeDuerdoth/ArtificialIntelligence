...
;;;======================================================
;;;
;;;Find the best trades based on Warren Buffet's personality
;;;
...
(deffacts warren-trade-rules

  ; Warren's for picking the best risk
  ...
  (rule (if fear is average)
        (then best-risk is less with certainty 85 and
              best-risk is average with certainty 60 and
              best-risk is risky with certainty 20))
  ...
  (rule (if has-dipped is yes and
            dip is 15)
        (then best-risk is average with certainty 70 and
              best-risk is very with certainty 65))

  (rule (if preferred-risk is risky)
        (then best-risk is risky with certainty 55))

  (rule (if preferred-risk is average)
        (then best-risk is average with certainty 55))
  ...
  (rule (if preferred-risk is unknown) 
        (then best-risk is less with certainty 65 and
              best-risk is average with certainty 40 and
              best-risk is risky with certainty 30))
  ...
  (rule (if main-component is stocks and
            has-dipped is no)
        (then best-term is long with certainty 90 and
              best-term is short with certainty 30))
  ...
  (rule (if main-component is cryptocurrency)
        (then best-term is short with certainty 30 and
            best-industry is cryptocurrency with certainty 50))
  ...
  (rule (if preferred-term is short)
        (then best-term is short with certainty 50))
  ...
  (rule (if has-dipped is yes and
            dip is 15)
        (then best-type is unpopular with certainty 20 and
              best-type is established with certainty 90))

  (rule (if preferred-type is trendy)
        (then best-type is trendy with certainty 20))

  (rule (if preferred-type is established)
        (then best-type is established with certainty 85))
  ...
  (rule (if preferred-type is unknown)
        (then best-type is trendy with certainty 15 and
              best-type is established with certainty 75 and
              best-type is unpopular with certainty 20))
  ...
  (rule (if has-tech is yes)
        (then best-industry is tech with certainty 65 and
              best-industry is food with certainty 50 and
              best-industry is entertainment with certainty 20))

      (rule (if has-tech is no)
        (then best-industry is tech with certainty 20 and
              best-industry is food with certainty 75 and
...
(deffacts TRADES::the-trade-list 
  (trade (name Dogecoin) (term long) (risk risky) (type trendy) (industry cryptocurrency))
  ...
  (trade (name Tesla) (term short) (risk average) (type established) (industry tech))
  (trade (name SpaceX) (term long) (risk risky) (type trendy) (industry tech))
  (trade (name FegToken) (term short) (risk risky) (type unpopular) (industry cryptocurrency))
  (trade (name ShibaInu) (term short) (risk risky) (type trendy) (industry cryptocurrency))
  (trade (name Apple) (term long) (risk average) (type established) (industry tech))
  (trade (name Bitcoin) (term long)(risk risky) (type established) (industry cryptocurrency))
  ...
  (trade (name Amazon) (term long) (risk average) (type established) (industry tech)))
...
(defrule TRADES::generate-trades
  ...
  (attribute (name best-industry) (value ?q) (certainty ?certainty-5))
  =>
...
(defrule PRINT-RESULTS::header ""
   ...
   (println " TRADE                  Warren's Certainty")
   (println " ----------------------------------------------------------------")
